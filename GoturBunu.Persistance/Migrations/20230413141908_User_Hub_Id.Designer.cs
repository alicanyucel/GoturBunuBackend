...
namespace GoturBunu.Persistance.Migrations
{
    ...
    [Migration("20230413141908_User_Hub_Id")]
    partial class User_Hub_Id
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoturBunu.Domain.Entities.Identity.RoleClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClaimValue = "CarrierHubConnectionPermission",
                        ...
                        new
                        {
                            Id = 7,
                            ClaimType = "https://goturbunu.com/identity/claims/permission",
                            ClaimValue = "OnOfferResponseCommandPermission",
                            RoleId = "9cf20d1a-9a51-4918-bd1b-29b972057fbf"
                        },
                        new
                        {
                            Id = 8,
                            ClaimType = "https://goturbunu.com/identity/claims/permission",
                            ClaimValue = "SendOfferToCommandPermission",
                            RoleId = "9cf20d1a-9a51-4918-bd1b-29b972057fbf"
                        },
                        new
                        {
                            Id = 9,
                            ClaimType = "https://goturbunu.com/identity/claims/permission",
                            ClaimValue = "SetCarrierHubIdCommandPermission",
                            RoleId = "9cf20d1a-9a51-4918-bd1b-29b972057fbf"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("GoturBunu.Domain.Entities.Offer.CarrierOffer", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("OfferStageId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("OfferStageId");

                    b.ToTable("CarrierOffers");
                });

            modelBuilder.Entity("GoturBunu.Domain.Entities.Offer.Offer", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GoturBunu.Domain.Entities.Offer.OfferStage", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GoturBunu.Domain.Entities.Offer.Packet", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GoturBunu.Domain.Entities.Store.StoreDetails", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StoreId = "36125b81-d8c6-4665-9c2f-ec95db4e8eac"
                        });
                });
            ...
            modelBuilder.Entity("GoturBunu.Domain.Entities.Offer.CarrierOffer", b =>
                {
                    b.HasOne("GoturBunu.Domain.Entities.Identity.User", "Carrier")
                        .WithMany()
                        .HasForeignKey("CarrierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GoturBunu.Domain.Entities.Offer.OfferStage", null)
                        .WithMany("CarrierOffers")
                        .HasForeignKey("OfferStageId");
            ...
            modelBuilder.Entity("GoturBunu.Domain.Entities.Offer.Offer", b =>
                {
                    b.HasOne("GoturBunu.Domain.Entities.Offer.Packet", "Packet")
                        .WithMany()
            ...
            modelBuilder.Entity("GoturBunu.Domain.Entities.Offer.OfferStage", b =>
                {
                    b.HasOne("GoturBunu.Domain.Entities.Offer.Offer", "Offer")
                        .WithMany("Stages")
            ...
            modelBuilder.Entity("GoturBunu.Domain.Entities.Offer.Packet", b =>
                {
                    b.HasOne("GoturBunu.Domain.Entities.Identity.User", "Store")
                        .WithMany()
